...
class ViT(nn.Module):
    ...
    def __init__(
        ...
        self.proj_back = nn.ConvTranspose3d(hidden_size, in_channels, kernel_size=patch_size, stride=patch_size)
    ...
    def forward(self, x,guidance):
        ...
        guidance = self.patch_embedding(guidance)
        ...
        x = x.transpose(1, 2).reshape(B, 64, D // 8, H // 8, W // 8)
        x = self.proj_back(x)
        return x
